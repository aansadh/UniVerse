...
); // setting _id false because it is embedded schema.
...
const eventSchema = new mongoose.Schema(
  {
    ...
    mode: {
      ...
      enum: {
        ...
        message:
          "{VALUE} is not accepted value. Only ['online', 'offline'] are allowed.",
      },
      required: [
        true,
        "Mode of event (['online', 'offline']) must be specified!",
      ],
    },
    maxParticipants: {
      type: Number,
